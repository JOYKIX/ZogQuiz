...
export const OVERLAY_DEFAULTS = {
  ...
  round3: {
    ...
    themeColor: "#cfe6ff",
    themeOverlayTextColor: "#cfe6ff",
    themeOverlayBackgroundColor: "#10233f",
    timerColor: "#8cf5dc",
...
export function normalizeOverlayConfig(roundKey, raw = {}) {
  ...
  if (roundKey === "round3") {
    ...
    return {
      ...
      themeOverlayTextColor: asColor(raw.themeOverlayTextColor ?? raw.themeColor, defaults.themeOverlayTextColor),
      themeOverlayBackgroundColor: asColor(raw.themeOverlayBackgroundColor, defaults.themeOverlayBackgroundColor),
